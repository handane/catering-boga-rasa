                ...
                <tbody>
                  ...
                  ?>
                    <tr style="font-size: 16px;" id="klik-tabel">
                      ...
                      <td>
                        <a class="btn btn-sm btn-success" href="edit-promosi.php?id_promosi=<?php echo $p['id_promosi_produk'] ?>"><img src="./../icons/pencil-square.svg" alt=""></a>
                        <a class="btn btn-sm btn-danger" onclick="return confirm('apakah anda yakin ingin menghapus data?')" href="delete.php?id_promosi=<?php echo $p['id_promosi_produk'] ?>"><img src="./../icons/trash-fill.svg" alt=""></a>
                      </td>
                    </tr>
                  <?php } ?>
                </tbody>
