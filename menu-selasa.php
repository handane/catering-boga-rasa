...
<body>
	...
	<div class="product-section mt-5 mb-150">
		...
		<div class="text-center tag">
				...
				<a href="produk.php" class="aktif cart-btn mb-4 col-md-2 text-center">Selasa</a>
		...
		<div class="row">
			<?php 
				$produk = mysqli_query($conn, "SELECT * FROM produk LEFT JOIN promosi ON produk.id_produk = promosi.id_produk  WHERE produk.menu_hari = 'Selasa'");
